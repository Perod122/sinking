                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <form id="delete-form-{{ $sinking->SinkID }}" action="{{ route('sinking.destroy', $sinking->SinkID) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $sinking->SinkID }})">
